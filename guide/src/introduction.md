...
After looking at the OSDev wiki, I found many of the tutorials to be extremely confusing and aimless
...
you through
a very simple implementation of an operating system, explaining every single detail and providing you with a pretty
...
Surprisingly, there are only a couple of things online that are aimed at getting beginners started on operating system 
development. 
...
Although this series of articles is aimed at beginners, I recommend making sure you know a bit about how any flavour of 
assembly works.
...
to debug whatever I write, Make files in order to build the project, and QEMU in order to run the OS without having to 
