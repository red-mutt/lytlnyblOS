...
how to do this as it varies alot based on the OS you are on. I will give
...
link the compilation of this in with our makefile using our cross
compiler:
...
And then if everything is done correctly we will be in C signified by
